        ...
        switch (message) {
            case "/start":
                ...
                message = "Привет! Я могу помочь тебе в поиске даты дежурства любой комнаты. Вот что я умею:\n" +
                        ...
                        "2. Ты можеш создать напоминание на дежурство своей комнаты. Нажми на кнопку \"Создать напоминание\", а после введи комнату, на которую хочеш создать напоминание.\n" +
                        ...
                        "Напоминания о дежурстве приходят около 9:00. Достаточно поставить напоминание 1 раз, а я буду постоянно проверять наличия новой даты дежурства выбраной комнаты! \n" +
            ...
            case "Поменять комнату для напоминания":
                ...
                message = "Введите комнату на которую хотите поменять напоминание";
                checkCreateReminder = true;
                sendMsg(message, chatId);
                break;
